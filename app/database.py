...
def _ensure_columns() -> None:
    ...
    statements = {
        ...
        "capital_per_trade": "ALTER TABLE strategy_configs ADD COLUMN capital_per_trade FLOAT NOT NULL DEFAULT 0.0",
    ...
    if "strategy_trades" in table_names:
        ...
        trade_statements = {
            ...
            "structural_target_level": "ALTER TABLE strategy_trades ADD COLUMN structural_target_level FLOAT",
        }
        with engine.begin() as connection:
